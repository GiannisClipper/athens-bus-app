const URI = {
    ...
    SCHEDULE_OF_LINE: 'https://telematics.oasa.gr/api/?act=getDailySchedule&line_code=',
    MAP_OF_ROUTE: 'https://telematics.oasa.gr/api/?act=webRouteDetails&p1=',
    MAP_OF_STOP: 'https://telematics.oasa.gr/api/?act=getClosestStops',
}
